"""
Code from https://github.com/ShirAmir/dino-vit-features
...
class ViTExtractor:
    ...
    def __init__(self, model_type: str = 'dino_vits8', stride: int = 4, model: nn.Module = None, model_path: str = None, device: str = 'cuda'):
        """
        ...
        if model_path is not None:
            ...
            for key, value in state_dict.items():
                if key.startswith('backbone.'):
                    new_state_dict[key[len('backbone.'):]] = value
                else:
    ...
    def extract_saliency_maps(self, batch: torch.Tensor) -> torch.Tensor:
        ...
        cls_attn_maps = (cls_attn_map - temp_mins[:, None]) / (temp_maxs - temp_mins)[:, None]  # normalize to range [0,1]
